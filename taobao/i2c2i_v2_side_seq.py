...
def geneTrainData(input_ori, label, flag, data_tag):
    ...
    train_target_item = input_ori[1]
    train_target_item_cat = input_ori[2]
    
    short_ub_expanded = input_ori[3][:,-30:]
    short_ub_expanded_cat = input_ori[4][:,-30:]
    
    long_ub_expanded = input_ori[3]
    long_ub_expanded_cat = input_ori[4]
    ...
    output_Path = '../model_input_taobao/' + flag + '_marm_i2c2i_input_' + str(MAX_LEN_ITEM) + data_tag + '.pkl'
    print(output_Path)
