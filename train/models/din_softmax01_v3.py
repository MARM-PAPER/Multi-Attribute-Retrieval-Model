...
def DIN_LN_SOFTMAX01_V3(feature_dim_dict, hist_feature_dim_dict, seq_feature_list, embedding_size=8, hist_len_max=16, hist_long_len_max=256,
    ...
    deep_input_emb = Concatenate()([Flatten()(NoMask()(deep_input_emb)), Flatten()(keys_emb), Flatten()(hist)])
